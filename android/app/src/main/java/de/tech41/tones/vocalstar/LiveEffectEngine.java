...
public enum LiveEffectEngine {
    ...
    public static native void setBlocksize(int blockSize);
    public static native int getRecordingDeviceId();
    public static native int getPlaybackDeviceId();
    ...
    public static native void setMicVolume(float volume);

    public static native void setupDSP(double sampleRate, int blockSize, boolean isMono);
