...
FilterButterworth24::FilterButterworth24(void)
{
    this->history1 = 0.f;
    this->history2 = 0.f;
    this->history3 = 0.f;
...
void FilterButterworth24::SetSampleRate(float fs)
{
...
void FilterButterworth24::Set(float cutoff, float q)
{
...
float FilterButterworth24::Run(float input)
{
